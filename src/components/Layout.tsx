...
export default function Layout({ children, currentPage, onPageChange }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-lg flex items-center justify-center shadow-md p-1">
              ...
              {/* Titolo compatto su mobile */}
              <div className="sm:hidden">
                <h1 className="text-base font-bold">GT Cantieri</h1>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <button
                ...
                className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-full overflow-hidden border-2 border-blue-400 hover:border-white transition-colors cursor-pointer"
              ...
              <button
                onClick={() => signOut()}
                className="flex items-center space-x-2 bg-blue-800 hover:bg-blue-700 px-3 sm:px-4 py-2 rounded-lg transition-colors"
              >
      ...
      {/* Navigation - Desktop: horizontal scroll, Mobile: hamburger menu */}
      <nav className="bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          {/* Mobile: Hamburger button + current page */}
          <div className="md:hidden flex items-center justify-between py-2">
            ...
            {currentMenuItem && (
              <div className="flex items-center space-x-2 text-blue-600">
                <currentMenuItem.icon className="w-4 h-4" />
                <span className="text-sm font-medium">{currentMenuItem.label}</span>
              </div>
            )}
          </div>
                ...
                {menuItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center space-x-2 px-3 py-2.5 text-sm font-medium rounded-lg transition-colors ${
                        currentPage === item.id

...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-3xl font-bold text-gray-900">Pannello di Controllo</h1>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-600">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-3xl font-bold text-gray-900 mt-2">{stats.totalWorkers}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-600">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-3xl font-bold text-gray-900 mt-2">{stats.activeWorkers}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-orange-600">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-3xl font-bold text-gray-900 mt-2">{stats.onBreak}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-600">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl sm:text-3xl font-bold text-gray-900 mt-2">{stats.todayAssignments}</p>
            </div>
